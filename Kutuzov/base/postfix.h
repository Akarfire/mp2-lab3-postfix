...
public:
	...
	template<typename T> 
	void GetMathObjectPointer(T*& OutPointer) { OutPointer = new T(); DeletionList.push_back(OutPointer); }// To be repalces with a buffered value if possible (no need to create more than one)
};
